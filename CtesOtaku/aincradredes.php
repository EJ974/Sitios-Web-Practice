...
<div class="row justify-content-center">
    <!-- Botón de WhatsApp -->
    <div class="col-auto">
        <a href="https://wa.me/3794652464" target="_blank">
    ...
    <!-- Botón de Instagram -->
    <div class="col-auto">
        <a href="//www.instagram.com/aincradsublimaciones/" target="_blank">
            <img src="img/instagram.png" alt="Instagram" style="background-color: orange; margin-top: -34px; width: 60px; height: 60px; background-size: cover; background-position: center; padding: 10px; border-radius: 20%;" >
        </a>
    </div>
